...
define('FPATH_DAO', FPATH_ROOT . DIRECTORY_SEPARATOR . 'dao');

// FDSSmarty
define('FPATH_TEMPLATES', FPATH_ROOT . DIRECTORY_SEPARATOR . 'templates');
define('FPATH_CSS', FPATH_ROOT . DIRECTORY_SEPARATOR . 'css');
define('FPATH_COMPILES', FPATH_ROOT . DIRECTORY_SEPARATOR . 'compiles');
define('FPATH_CONFIGS', FPATH_ROOT . DIRECTORY_SEPARATOR . 'configs');
define('FPATH_CACHE', FPATH_ROOT . DIRECTORY_SEPARATOR . 'cache');
